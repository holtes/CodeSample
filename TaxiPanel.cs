...
public class TaxiPanel : MonoBehaviour
{
    public Color color;
    private void Awake()
    {
    ...
    private void OnEnable()
    {
        ...
        //if(texture!=null) ZeroPointUI.me1.hexagonsController.SetTexture(texture.texture);
        string jsonString = JsonDBProvider.getJsonString("Taxi",2);
